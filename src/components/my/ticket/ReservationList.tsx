...
const ReservationList: React.FC<Props> = ({ filter, viewDate }) => {
  ...
  return (
    <div className={styles.list}>
      {items.map((it) => (
        <article key={it.id} className={styles.card} onClick={() => openDetail(it.id)}>
          ...
          <div className={styles.body}>
            ...
            <div className={styles.info}>
              <div className={styles.row}>
                ...
                <span className={styles.v}>{it.reservationNo}</span>
              </div>
              <div className={styles.row}>
                <span className={styles.k}>예매일</span>
                <span className={styles.v}>{it.reservedDate}</span>
              </div>
              <div className={styles.row}>
                <span className={styles.k}>장소</span>
                <span className={styles.v}>{it.venue}</span>
              </div>
              <div className={styles.row}>
                <span className={styles.k}>관람일시</span>
                <span className={styles.v}>{it.showDateTime}</span>
              </div>
              <div className={styles.row}>
                <span className={styles.k}>상태</span>
                <span className={styles.v}>{it.status}</span>
              </div>
            </div>
          </div>
        </article>
